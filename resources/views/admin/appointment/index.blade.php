    ...
    <form action="{{ route('appointment.check') }}" method="post">
      ...
      <div class="card">
        ...
        <div class="card-body">
          ...
          <br>
          <button type="submit" class="btn btn-primary">Check Dates</button>
        </div>
      </div>
    </form>
        ...
        <div class="card-body">
          ...
          <table class="table table-striped">
            ...
            <tr>
              ...
              <td><input type="checkbox" name="time[]"  value="7.40pm" @if(isset($times)){{ $times->contains('time', '7.20pm') ? 'checked': ''}} @endif>7.40pm</td>
            </tr>
            <tr>
              <th scope="row">15</th>
